(function(root){
  ...
  const modelLabel=id=>({"f975b97fcfef2b127c857b5225db0b8df5f8755e6182f9382797f5299ba38811":'ver1','instagram-adaptive-v0.1':'ver1','price-environment-v1':'추정 ver1'})[id]||'미등록 버전';
  const api={modelLabel,assets,assetIds,assetId,validDate,clone,validSettings,snapshot,validateRecord};
